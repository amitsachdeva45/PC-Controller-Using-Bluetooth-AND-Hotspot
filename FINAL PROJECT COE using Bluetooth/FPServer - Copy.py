...
def present():
    ...
    while True:
        ...
        if presenti==0 and data[0]==1 and data[2]==4:
            ...
            presentation = app.Presentations.Open('E:\ppt\Monte Carlo.ppt', ReadOnly=1)
        ...
        if data[0]==0 and rr<slide_count and data[2]==4:
            ...
            if data[1]==2:
                ...
                flagg1=0
            rr=rr+1
        if rr==slide_count and flagg1==1:
            presentation.SlideShowWindow.View.Exit()
            #del presentation
            #app.Quit()
        if data[2]!=4:
...
def music():
    ...
    while True:
        ...
        if i1==0 and pp[2]==2 and pp[1]!=0:
            ...
            p1=p
            print "i=0"
        elif pp[2]==2 and i1!=0 and pp[1]!=0:
            flagg=1
            p1.stop()
            print value
            p = vlc.MediaPlayer(r)
...
def keyboard():
    ...
    if ff[2]!=1:
        mainflag=ff[2]
        B=tk.Button(frame,text="QUIT",width=10,height=10,command=quit1)
        B.place(x='0',y='0')
        i=0
        return
...
def mouse():
    ...
    while True:
        ...
        yy=float(y)
        flag=coor[3]
        if flag==2 and coor[2]==3:
                print("1")
                pyautogui.click(x,y,button='right')
        elif flag==1 and coor[2]==3:
                print("2")
                pyautogui.click()
                
        elif flag==3 and coor[2]==3:
