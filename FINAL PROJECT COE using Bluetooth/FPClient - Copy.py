...
def mouse():
    ...
    global right
    root95=tk.Tk()
    root95.geometry('1368x768+100+100')
    left=False
    right=False
...
#B.pack()
        ...
        getFolderPlaylists('E:\WhatsAppAudio')
#B.pack()
        root.mainloop()
    elif mainflag==5:
        break
