...
musstart=""
pptstart=""
print "connected Bluetooth"+"5c:ac:4c:d3:ec:95"
def mouse():
    while True:
        global xx
        global yy
...
def music():
    global muslist
    getFolderPlaylists1('E:\WhatsAppAudio',2)
    i1=0
    value=0
    p1=0
    flag4=0
...
musppt=0
getFolderPlaylists1('E:\WhatsAppAudio',3)
getFolderPlaylists1('E:\ppt',4)
